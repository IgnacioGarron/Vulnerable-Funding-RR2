...
for (h in h_horizon){
  ...
  for (country_name in stock_countries){ # acá empieza loop para país CAMBIAR PARA GAR E EAR
    ...
    data_model<-data_reg %>% 
      group_by(country) %>% 
      filter(complete.cases(stock_h,stock_z,NFCI_z,f_global_z),country==country_name) 
...
save(coef_b1,file ="../Data/M1_stock_baseline_coef_b1.RData")
save(coef_b2,file ="../Data/M1_stock_baseline_coef_b2.RData")
save(coef_b3,file ="../Data/M1_stock_baseline_b3.RData")
save(coef_b4,file ="../Data/M1_stock_baseline_b4.RData")
save(coef_b5,file ="../Data/M1_stock_baseline_b5.RData")


save(sig_b1,file ="../Data/M1_stock_baseline_sig_b1.RData")
save(sig_b2,file ="../Data/M1_stock_baseline_sig_b2.RData")
save(sig_b3,file ="../Data/M1_stock_baseline_sig_b3.RData")
save(sig_b4,file ="../Data/M1_stock_baseline_sig_b4.RData")
save(sig_b5,file ="../Data/M1_stock_baseline_sig_b5.RData")
