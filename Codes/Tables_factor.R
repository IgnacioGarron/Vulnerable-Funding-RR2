...
loadRData <- function(fileName){
 ...
 for (var in c("gdp","stock","credit")){
   ...
   M1_b1 <- loadRData(paste0("Data/M1_",var,"_factor_coef_b1.RData"))
   M1_sig1 <- loadRData(paste0("Data/M1_",var,"_factor_sig_b1.RData"))
   M1_b2 <- loadRData(paste0("Data/M1_",var,"_factor_coef_b2.RData"))
   M1_sig2 <- loadRData(paste0("Data/M1_",var,"_factor_sig_b2.RData"))
   M1_b3 <- loadRData(paste0("Data/M1_",var,"_factor_coef_b3.RData"))
   M1_sig3 <- loadRData(paste0("Data/M1_",var,"_factor_sig_b3.RData"))
   M1_b4 <- loadRData(paste0("Data/M1_",var,"_factor_coef_b4.RData"))
   M1_sig4 <- loadRData(paste0("Data/M1_",var,"_factor_sig_b4.RData"))
   
   M2_b1 <- loadRData(paste0("Data/M2_",var,"_factor_coef_b1.RData"))
   M2_sig1 <- loadRData(paste0("Data/M2_",var,"_factor_sig_b1.RData"))
   M2_b2 <- loadRData(paste0("Data/M2_",var,"_factor_coef_b2.RData"))
   M2_sig2 <- loadRData(paste0("Data/M2_",var,"_factor_sig_b2.RData"))
   M2_b3 <- loadRData(paste0("Data/M2_",var,"_factor_coef_b3.RData"))
   M2_sig3 <- loadRData(paste0("Data/M2_",var,"_factor_sig_b3.RData"))
   M2_b4 <- loadRData(paste0("Data/M2_",var,"_factor_coef_b4.RData"))
   M2_sig4 <- loadRData(paste0("Data/M2_",var,"_factor_sig_b4.RData"))
  
   M3_b1 <- loadRData(paste0("Data/M3_",var,"_factor_coef_b1.RData"))
   M3_sig1 <- loadRData(paste0("Data/M3_",var,"_factor_sig_b1.RData"))
   ...
   M3_b4 <- loadRData(paste0("Data/M3_",var,"_factor_coef_b4.RData"))
   M3_sig4 <- loadRData(paste0("Data/M3_",var,"_factor_sig_b4.RData"))
   M3_b5 <- loadRData(paste0("Data/M3_",var,"_factor_coef_b5.RData"))
   M3_sig5 <- loadRData(paste0("Data/M3_",var,"_factor_sig_b5.RData"))
   
   
   
   M1_TL  <- loadRData(paste0("Data/M1_",var,"_factor_TL.RData"))
   M1_TLb <- loadRData(paste0("Data/M1_",var,"_TL.RData"))
   
   M2_TL <- loadRData(paste0("Data/M2_",var,"_factor_TL.RData"))
   ...
   for (h in c("1","4","8","12")){
     ...
     write.table(tabla, file = paste0("Tables/baseline_reg_factor_",var,"h_",h,".txt"), sep = ",", quote = FALSE, row.names = F)
